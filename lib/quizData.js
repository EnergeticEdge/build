...
// 12 headlines: 4 states x 3 score bands (high 70+, mid 40-69, low <40), band is based
// on the overall score (average of Energy and Focus). Every headline names the state
// and uses the score. Edge is always framed as "how far do you want to go", never as
// a warning about being close to the line.
export const HEADLINES = {
  [STATES.EDGE]: {
    high: (score) =>
      `You're in Edge, and the number backs it up: ${score}%. Energy and focus are both working for you right now. The question isn't whether you're doing enough. It's whether you want to find out how far this version of you can actually go.`,
    mid: (score) =>
