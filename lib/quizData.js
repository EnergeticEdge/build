...
// Short CTA section pushing straight to the call, same across states.
export const EDGE_BACK_COPY = {
  heading: "Let's get your Edge back",
  body: 'We want you energised, decisive, grounded and engaged in your business. So make the first decision, and jump on a call.',
};

// Contact block copy (same across states).
export const CONTACT_COPY = {
  heading: 'Talk to Keith directly',
  body: 'Questions about your result or what to do next: email info@theenergeticedge.com or use the free call above.',
};
