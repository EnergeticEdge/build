...
const REQUIRED_CUSTOM_FIELDS = [
  ...
  // Set on subscribers who came through the SIMPLER Guide download instead of
  // (or as well as) the quiz. See app/api/guide/download/route.js.
  { name: 'guide_downloaded', kind: 'boolean' },
];
