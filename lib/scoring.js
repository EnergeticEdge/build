...
// DUAL_QUESTION (Q11) contributes 0-3 to *both* axes depending on which option was
// picked, on top of the five pure questions per axis. So each axis maxes at
// 5 * 3 (pure questions) + 3 (Q11's contribution) = 18. Derived from
// SCORED_QUESTIONS's length rather than hardcoded, so this stays correct if the
// question count per axis ever changes again.
const PURE_MAX_PER_AXIS = ENERGY_QUESTION_IDS.length * 3;
const AXIS_MAX = PURE_MAX_PER_AXIS + 3;
