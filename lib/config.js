...
// Price shown as a was/now badge next to the call CTA, so it stands out rather
// than sitting flat inside a sentence. Kept separate from CALL_COPY below.
export const CALL_PRICE = { was: '£197', now: 'Free' };

export const CALL_COPY =
  "You've earned a 30-minute call with Keith, on the house because you finished the quiz. He'll read your results before you speak and give you one focused action.";
